...
**Case 1**: income<=81 and income>81
...
**Case 2**: income<=72 and income>72
...
It is clear that we should split samples into "age is less or equal to 50" and "age is more than 50" (the number 50 can be repalced by any number in [50,53)), since both the entropy in the left and right will be 0 and the information gain would maximize.
